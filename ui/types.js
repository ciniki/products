    ...
    this.init = function() {
        ...
        this.edit.sections = {
            ...
            'parent_products':{'label':'Parent', 'aside':'yes', 'fields':{
                ...
                'parent_product_sequence':{'label':'Sequence', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
...
//              'parent_product_supplier_product_id':{'label':'Supplier Product ID', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                ...
                'parent_product_sell_unit':{'label':'Sell Unit', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                ...
                'parent_product_inventory_reorder_num':{'label':'Inventory Reorder Num', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                'parent_product_inventory_reorder_quantity':{'label':'Inventory Reorder Quantity', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
...
//              'child_product_supplier_product_id':{'label':'Supplier Product ID', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                ...
                'child_product_sell_unit':{'label':'Sell Unit', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                ...
                'child_product_inventory_reorder_num':{'label':'Inventory Reorder Num', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
                'child_product_inventory_reorder_quantity':{'label':'Inventory Reorder Quantity', 'type':'toggle', 'default':'off', 'toggles':this.fieldOptions},
