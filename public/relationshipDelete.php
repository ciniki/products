...
function ciniki_products_relationshipDelete(&$ciniki) {
    ...
    $rc = ciniki_products_checkAccess($ciniki, $args['business_id'], 'ciniki.products.relationshipDelete', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
	...
	if( $rc['stat'] != 'ok' ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1534', 'msg'=>'Unable to get existing relationship information', 'err'=>$rc['err']));
	}
	if( !isset($rc['relationship']) ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1535', 'msg'=>'Unable to get existing relationship information'));
	}
	...
	return ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.products.relationship', $args['relationship_id'], $uuid, 0x07);
}
?>
