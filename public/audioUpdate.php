...
function ciniki_products_audioUpdate(&$ciniki) {
    ...
    if( !isset($rc['item']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.products.172', 'msg'=>'Product audio not found'));
    }
    $item = $rc['item'];
    ...
    if( isset($args['name']) ) {
        ...
        if( $rc['num_rows'] > 0 ) {
            return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.products.173', 'msg'=>'You already have an audio with this name, please choose another name'));
        }
    }
