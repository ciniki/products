...
function ciniki_products_fileUpdate(&$ciniki) {
    ...
    $rc = ciniki_products_checkAccess($ciniki, $args['tnid'], 'ciniki.products.fileUpdate', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    return ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.products.file', $args['file_id'], $args, 0x07);
}
?>
