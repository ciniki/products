...
// <rsp stat='ok' />
//
function ciniki_products_pdfcatalogUpdate(&$ciniki) {
    //
    ...
    $rc = ciniki_products_checkAccess($ciniki, $args['business_id'], 'ciniki.products.pdfcatalogUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
    // Update the PDF Catalog in the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectUpdate');
    $rc = ciniki_core_objectUpdate($ciniki, $args['business_id'], 'ciniki.products.pdfcatalog', $args['catalog_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
...
//    ciniki_core_hookExec($ciniki, $args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.products.pdfcatalog', 'object_id'=>$args['catalog_id']));
